class TestBench_efp_point_adder_doubler(TB_aluEC_prime):
    ...
    def add_doubling(self, P, Q, R):
        self.add_action( "func(" + self.dp.ec1_point_to_vhdl_string(P) +", -- P" )
        self.add_action( "     " + self.dp.ec1_point_to_vhdl_string(Q) +", -- Q (unused in doubling)" )
        self.add_action( "     " + self.dp.ec1_point_to_vhdl_string(R) +", -- R" )
...
class Eefp_point_adder_doubler(Entity):
    def __init__(self, dp):
        self.id = "ec/efp_point_adder_doubler"
        self.src = [ "efp_point_adder_doubler.vhd" ]
        self.dep = [
            "field/fp_adder_subtractor",
            "field/fp_multiplier",
            "field/fp_divider"
            ]
    ...
    def get_default_tb(self, dp):
        return TestBench_efp_point_adder_doubler(dp, self)

obj = Eefp_point_adder_doubler(dp)
